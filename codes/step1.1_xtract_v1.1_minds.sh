#!/bin/bash
#SBATCH --job-name=marmoset_xtract_v1.1_minds
#SBATCH --output=log/marmoset_xtract_v1.1_minds.%A_%a.out
#SBATCH --error=log/marmoset_xtract_v1.1_minds.%A_%a.out
...
arr=(`cat /n02dat01/users/yfwang/Data/marmoset_brain_minds/list_t1_dwi.txt`)
...
datadir=/n02dat01/users/yfwang/Data/marmoset_brain_minds/invivo
subdir=/n02dat01/users/yfwang/MarmosetWM/result/xtract_result_v1.1_minds/${sub}
mkdir -p ${subdir}
...
./xtract_ants_minds -bpx ${datadir}/${sub}/DTI.bedpostX \
                    -out ${subdir}/xtract \
                    -species CUSTOM \
