#!/bin/bash
#SBATCH --job-name=marmoset_wb_pbx_brain_minds
#SBATCH --output=log/marmoset_wb_pbx_brain_minds.%A_%a.out
#SBATCH --error=log/marmoset_wb_pbx_brain_minds.%A_%a.out
#SBATCH --partition=gpu
#SBATCH --gres=gpu:1
#SBATCH --array=0-109

resultpath=/gpfs/userdata/yfwang/Data/marmoset_brain_minds_preprocessed/invivo
