...
arr=(`cat /gpfs/backup/NHP_data/backup_marmoset/marmoset_MBM/marmoset_MBM_list.txt`)
sub=${arr[$SLURM_ARRAY_TASK_ID]}

datadir=/gpfs/backup/NHP_data/backup_marmoset/marmoset_MBM
subdir=/n05dat/yfwang/user/MarmosetWM/result/xtract_result_v1.1_MBM/${sub}
