...
datapath=/gpfs/userdata/yfwang/MarmosetWM/result/af_projection/result/af_projection
...
# macaque -> human
wb_command -metric-resample ${datapath}/macaque_af_l.func.gii \
                            ${deform_mac2hum_32k_l} \
                            ${human_sphere_32k_l} \
                            BARYCENTRIC \
                            ${resultpath}/af_projection_registered_group/macaque-to-human.af_l.func.gii
wb_command -metric-resample ${datapath}/macaque_af_r.func.gii \
                            ${deform_mac2hum_32k_r} \
                            ${human_sphere_32k_r} \
                            BARYCENTRIC \
                            ${resultpath}/af_projection_registered_group/macaque-to-human.af_r.func.gii

# marmoset -> macaque -> human
wb_command -metric-resample ${datapath}/marmoset_af_l.func.gii \
                            ${resultpath}/surfFS_matched.L.sphere.surf.gii \
                            ${marmoset_sphere_10k_l} \
                            BARYCENTRIC \
                            ${resultpath}/af_projection_registered_group/marmoset_af_l.10k.func.gii
wb_command -metric-resample ${datapath}/marmoset_af_r.func.gii \
                            ${resultpath}/surfFS_matched.R.sphere.surf.gii \
                            ${marmoset_sphere_10k_r} \
                            BARYCENTRIC \
                            ${resultpath}/af_projection_registered_group/marmoset_af_r.10k.func.gii

wb_command -metric-resample ${resultpath}/af_projection_registered_group/marmoset_af_l.10k.func.gii \
                            ${deform_mar2mac_l} \
                            ${macaque_sphere_10k_l} \
                            BARYCENTRIC \
                            ${resultpath}/af_projection_registered_group/marmoset-to-macaque.af_l.10k.func.gii
wb_command -metric-resample ${resultpath}/af_projection_registered_group/marmoset_af_r.10k.func.gii \
                            ${deform_mar2mac_r} \
                            ${macaque_sphere_10k_r} \
                            BARYCENTRIC \
                            ${resultpath}/af_projection_registered_group/marmoset-to-macaque.af_r.10k.func.gii

wb_command -metric-resample ${resultpath}/af_projection_registered_group/marmoset-to-macaque.af_l.10k.func.gii \
                            ${deform_mac2hum_l} \
                            ${human_sphere_10k_l} \
                            BARYCENTRIC \
                            ${resultpath}/af_projection_registered_group/marmoset-to-human.af_l.10k.func.gii
wb_command -metric-resample ${resultpath}/af_projection_registered_group/marmoset-to-macaque.af_r.10k.func.gii \
                            ${deform_mac2hum_r} \
                            ${human_sphere_10k_r} \
                            BARYCENTRIC \
                            ${resultpath}/af_projection_registered_group/marmoset-to-human.af_r.10k.func.gii

wb_command -metric-resample ${resultpath}/af_projection_registered_group/marmoset-to-human.af_l.10k.func.gii \
                            ${human_sphere_10k_l} \
                            ${human_sphere_32k_l} \
                            BARYCENTRIC \
                            ${resultpath}/af_projection_registered_group/marmoset-to-human.af_l.32k.func.gii
wb_command -metric-resample ${resultpath}/af_projection_registered_group/marmoset-to-human.af_r.10k.func.gii \
                            ${human_sphere_10k_r} \
                            ${human_sphere_32k_r} \
                            BARYCENTRIC \
                            ${resultpath}/af_projection_registered_group/marmoset-to-human.af_r.32k.func.gii
