...
subs_marmoset = textread('marmoset_minds_list.txt', '%s');
...
for h=1:length(subs_human)
    for m=1:length(subs_marmoset)
        ...
        bp_marmoset_l = load(strcat(resultpath, 'bp_atlas_indi/marmoset_minds/', subs_marmoset{m}, '_BP_atlas.L.txt'));
        bp_marmoset_r = load(strcat(resultpath, 'bp_atlas_indi/marmoset_minds/', subs_marmoset{m}, '_BP_atlas.R.txt'));
...
save(temp_human_l, strcat(resultpath, 'minKL_indi_dataset/mar2h_minds_minKL_on_human_atlas.L.func.gii'));
save(temp_human_r, strcat(resultpath, 'minKL_indi_dataset/mar2h_minds_minKL_on_human_atlas.R.func.gii'));

save(strcat(resultpath, 'minKL_indi_dataset/mar2h_minds_minKL_on_human_atlas.L.txt'), 'minKL_mar2h_L', '-ascii');
save(strcat(resultpath, 'minKL_indi_dataset/mar2h_minds_minKL_on_human_atlas.R.txt'), 'minKL_mar2h_R', '-ascii');

save(strcat(resultpath, 'minKL_indi_dataset/mar2h_minds_minKL_on_human_atlas_all_subject.L.mat'), 'minKL_mar2h_all_L');
save(strcat(resultpath, 'minKL_indi_dataset/mar2h_minds_minKL_on_human_atlas_all_subject.R.mat'), 'minKL_mar2h_all_R');
