...
save(temp_human_l, strcat(resultpath, 'minKL_indi/mar2h_minKL_on_human_atlas.L.func.gii'));
save(temp_human_r, strcat(resultpath, 'minKL_indi/mar2h_minKL_on_human_atlas.R.func.gii'));

save(strcat(resultpath, 'minKL_indi/mar2h_minKL_on_human_atlas.L.txt'), 'minKL_mar2h_L', '-ascii');
save(strcat(resultpath, 'minKL_indi/mar2h_minKL_on_human_atlas.R.txt'), 'minKL_mar2h_R', '-ascii');

save(strcat(resultpath, 'minKL_indi/mar2h_minKL_on_human_atlas_all_subject.L.mat'), 'minKL_mar2h_all_L');
save(strcat(resultpath, 'minKL_indi/mar2h_minKL_on_human_atlas_all_subject.R.mat'), 'minKL_mar2h_all_R');
