...
datapath = '/gpfs/userdata/yfwang/preprocess_fsl/macaque_ucd/';
...
subs = textread('/gpfs/userdata/yfwang/preprocess_fsl/macaque_ucd/macaque_ucdavis_list.txt', '%s');
...
for i=1:subs_len
    ...
    save(strcat(resultpath, 'macaque_ucd/', subs{i}, '_BP_atlas.L.txt'), 'bp_atlas_l', '-ascii');
    save(strcat(resultpath, 'macaque_ucd/', subs{i}, '_BP_atlas.R.txt'), 'bp_atlas_r', '-ascii');
end
