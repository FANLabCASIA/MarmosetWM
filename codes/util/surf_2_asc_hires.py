...
datapath = '/gpfs/userdata/yfwang/MarmosetWM/support_data/surf'

WD = '/gpfs/userdata/yfwang/MarmosetWM/revision_NC/af_slf_validation'
if not os.path.exists(f'{WD}/surf'):
    os.mkdir(f'{WD}/surf')
...
for surf in ['white', 'pial']:
    ...
    #########################
    # ants_mat_path = f'{WD}/affine/ind2MBMv3/ind2MBMv30GenericAffine.mat'
    # ants_warp_path = f'{WD}/affine/ind2MBMv3/ind2MBMv31Warp.nii.gz'
    ants_mat_path = '/gpfs/userdata/yfwang/MarmosetWM/result/affine/FA200temp_80indi/FA0GenericAffine.mat'
    ants_warp_path = '/gpfs/userdata/yfwang/MarmosetWM/result/affine/FA200temp_80indi/FA1InverseWarp.nii.gz'

    trans_template_path = f'{datapath}/surfFS_{hemi}_{surf}.csv'
    trans_DTI_path = f'{WD}/surf/surfFS_{hemi}_{surf}.csv'
    ...
    header2 = '37974 75944'
    with open(f'{WD}/surf/DTI_{hemi}_{surf}.asc', 'w') as f:
        f.write(header1)
        f.write('\r\n')
        f.write(header2)
        f.write('\r\n')
    ...
    # write surf
    ############
    asc_path = f'{WD}/surf/DTI_{hemi}_{surf}.asc'
    gii_path = f'{WD}/surf/DTI_{hemi}_{surf}.surf.gii'
