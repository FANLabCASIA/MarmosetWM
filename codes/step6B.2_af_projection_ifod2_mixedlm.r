...
## read fdata
df <- read.csv(file.path(WD, paste0("af_projection_", ROI, "_ifod2_thr", thr, ".csv")), stringsAsFactors = TRUE)
...
## write to csv
write.csv(df_emm,         file.path(WD, paste0("af_projection_", ROI, "_ifod2_thr", thr, "_emm.csv")), row.names = FALSE)
write.csv(df_species,     file.path(WD, paste0("af_projection_", ROI, "_ifod2_thr", thr, "_emm_pairs_between_species.csv")), row.names = FALSE)
write.csv(df_hemispheres, file.path(WD, paste0("af_projection_", ROI, "_ifod2_thr", thr, "_emm_pairs_between_hemispheres.csv")), row.names = FALSE)
write.csv(df_interaction, file.path(WD, paste0("af_projection_", ROI, "_ifod2_thr", thr, "_emm_interaction.csv")), row.names = FALSE)