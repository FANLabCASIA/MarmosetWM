#!/bin/bash
#SBATCH --job-name=marmoset_xtract_brain_minds
#SBATCH --output=log/marmoset_xtract_brain_minds.%A_%a.out
#SBATCH --error=log/marmoset_xtract_brain_minds.%A_%a.out
...
arr=(`cat ${supportdatapath}/marmoset_brain_minds_dwi_list_126.txt`)
...
./xtract_ants_minds -bpx ${datapath}/${sub}/DTI.bedpostX \
                    -out ${subdir}/xtract \
                    -species CUSTOM \
